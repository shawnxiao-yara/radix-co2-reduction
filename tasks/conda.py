...
def create(c):
    ...
    logger.info("Recreating conda environment co2-reduction-env...")
    ...
    logger.info("Installing editable co2_reduction into conda environment...")
...
def update(c):
    ...
    logger.info("Updating conda environment co2-reduction-env...")
    c.run("conda-merge environment.run.yml environment.dev.yml > environment.yml", pty=True)
